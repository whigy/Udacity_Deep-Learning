...
with graph.as_default():
  ...
  # Variables.
  weights1 = tf.get_variable("weights1", shape=[image_size * image_size, node_size1],
           initializer=tf.contrib.layers.xavier_initializer())
  #weights1 = tf.Variable(
  #  tf.truncated_normal([image_size * image_size, node_size1]))
  biases1 = tf.Variable(tf.zeros([node_size1]))

  weights2 = tf.get_variable("weights2", shape=[node_size1, node_size2],
           initializer=tf.contrib.layers.xavier_initializer())
  biases2 = tf.Variable(tf.zeros([node_size2]))

  weights3 = tf.get_variable("weights3", shape=[node_size2, num_labels],
           initializer=tf.contrib.layers.xavier_initializer())
  ...
  # Training computation.
      ...
      drop1 = tf.nn.dropout(relu1, dropout_rate)
      layer2 = tf.matmul(drop1, weights2) + biases2
      relu2 = tf.nn.relu(layer2)
      drop2 = tf.nn.dropout(relu2, dropout_rate)
      layer3 = tf.matmul(drop2, weights3) + biases3
      return layer3
  ...
  loss = tf.reduce_mean(
    tf.nn.softmax_cross_entropy_with_logits(labels=tf_train_labels, logits=logits))
  loss += 0.5 * beta * (tf.nn.l2_loss(weights1) + tf.nn.l2_loss(weights2)+ tf.nn.l2_loss(weights3))
...
with tf.Session(graph=graph) as session:
  ...
  """
  Initialized
Minibatch loss at step 0: 2.762476
Minibatch accuracy: 7.8%
Validation accuracy: 40.4%
Minibatch loss at step 500: 0.698809
Minibatch accuracy: 89.8%
Validation accuracy: 85.6%
Minibatch loss at step 1000: 0.777211
Minibatch accuracy: 85.9%
Validation accuracy: 86.5%
Minibatch loss at step 1500: 0.541658
Minibatch accuracy: 91.4%
Validation accuracy: 87.8%
Minibatch loss at step 2000: 0.526354
Minibatch accuracy: 93.0%
Validation accuracy: 87.9%
Minibatch loss at step 2500: 0.534355
Minibatch accuracy: 89.1%
Validation accuracy: 88.3%
Minibatch loss at step 3000: 0.578659
Minibatch accuracy: 87.5%
Validation accuracy: 88.4%
Minibatch loss at step 3500: 0.561545
Minibatch accuracy: 89.1%
Validation accuracy: 88.7%
Minibatch loss at step 4000: 0.457274
Minibatch accuracy: 91.4%
Validation accuracy: 89.1%
Beta = 0.001000; Test accuracy: 95.0%

Conclusion:  xavier_initializer is very import for ReLU!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  """